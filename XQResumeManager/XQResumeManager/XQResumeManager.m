...
@interface XQResumeManager ()<NSURLSessionDelegate, NSURLSessionTaskDelegate>
...
@implementation XQResumeManager
...
+ (XQResumeManager *)resumeManagerWithURL:(NSURL*)url
    ...
    XQResumeManager *manager = [[XQResumeManager alloc]init];
